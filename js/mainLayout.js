...
export let navBurger;
export let headerTitle;
export let playToggle;
export let rect1;
export let rect2;
export let rect3;
export let trainCaption;
export let playCaption;
export let overlayDiv;
export let navSidebar;
export let bottomDiv;
export let starsContainer;
export let startPlayBtn;
export let resultDiv;
export let loseCaption;
