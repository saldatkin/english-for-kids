export const sidebar = ['menu', 'actions', 'animals',
  'animals2', 'clothes', 'digits', 'food', 'fruits', 'nature', 'stats'];
...
export const constantsArray = [menu, actions, animals, animals2,
  clothes, digits, food, fruits, nature];
export const tableHeaders = ['word', 'category', 'translation',
  'trained', 'correct', 'mistakes', 'mistakes, %'];
